...
const char* lookup(const char* path)
{
    ...
    if(strncasecmp(ending, ".css", 4) == 0) {
        return "text/css";
    }
    else if(strncasecmp(ending, ".html", 5) == 0) {
        return "text/html";
    }
    else if(strncasecmp(ending, ".gif", 4) == 0) {
        return "image/gif";
    }
    else if(strncasecmp(ending, ".ico", 4) == 0) {
        return "image/x-icon";
    }
    else if(strncasecmp(ending, ".jpg", 4) == 0) {
        return "image/jpeg";
    }
    else if(strncasecmp(ending, ".js", 3) == 0) {
        return "text/javascript";
    }
    else if(strncasecmp(ending, ".php", 4 ) == 0) {
        return "text/x-php";
    }
    else if(strncasecmp(ending, ".png", 4) == 0) {
        return "image/png";
    }
    else {
        return NULL;
